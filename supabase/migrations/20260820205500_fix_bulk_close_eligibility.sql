...
begin
  ...
  loop
    ...
    if found then
      ...
      values (
        ...
        actor_id,
        'CLOSED',
        jsonb_build_object('exceptional', true, 'bulk', true, 'reason', normalized_reason, 'confirmation', p_confirmation),
  ...
  return jsonb_build_object('totalReady', total_ready, 'closedCount', closed_count, 'skippedCount', skipped_count);
end;
$$;
